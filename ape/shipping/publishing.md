...
**Templates only.** Real Vinted repos can't be published – those ship through [pull requests](/ape-docs/ape/shipping/pull-requests/.md).
...
* **[Sharing](/ape-docs/ape/working-with-others/sharing/.md)** – the other way to show someone your work, without making it public.
* **[Templates and projects](/ape-docs/ape/concepts/templates-and-projects/.md)** – why only templates can be published, and what to start one from.
* **[Comments and notes](/ape-docs/ape/working-with-others/comments-and-notes/.md)** – collecting feedback on what you've shared.
