...
**[Projects](https://app.bloom-ai-poc.svc.vinted.com/projects) only.** [Templates](https://app.bloom-ai-poc.svc.vinted.com/templates) have no upstream repository, so there's nothing to open a PR against – the equivalent for a template is [publishing](/ape-docs/ape/shipping/publishing/.md).
...
Your GitHub token is already sorted – you couldn't have created a session on a real repo without it. See [Getting access](/ape-docs/ape/getting-started/getting-access/.md) if you need to check it.
...
* **[How your work is saved](/ape-docs/ape/concepts/how-your-work-is-saved/.md)** – the branch model behind this, and why nothing reaches master by accident.
* **[Files and history](/ape-docs/ape/the-workspace/files-and-history/.md)** – reviewing your own diff before you open the PR.
* **[Publishing](/ape-docs/ape/shipping/publishing/.md)** – what to do instead when you're on a template.
