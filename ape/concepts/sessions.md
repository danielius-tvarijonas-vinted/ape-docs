...
![Sessions](/ape-docs/assets/images/ape-02-concepts-sessions-create-72f39024dc00bc7789f437ae71219de5.png)

From **[Templates](https://app.bloom-ai-poc.svc.vinted.com/templates)** or **[Projects](https://app.bloom-ai-poc.svc.vinted.com/projects)**, pick something and click **Create session**. On a real repo you can also choose which branch to start from; it defaults to the repo's default branch.

**Explore** on the [home screen](https://app.bloom-ai-poc.svc.vinted.com/) skips the picker and gives you a blank template immediately.
...
![Sessions](/ape-docs/assets/images/ape-02-concepts-sessions-rename-6f429780d86c5322a7f86f21622c51e8.png)
...
* **[How your work is saved](/ape-docs/ape/concepts/how-your-work-is-saved/.md)** – what survives when a session sleeps, and what doesn't when you delete one.
* **[Templates and projects](/ape-docs/ape/concepts/templates-and-projects/.md)** – deciding what to start a session from.
* **[The session screen](/ape-docs/ape/the-workspace/the-session-screen/.md)** – what you're looking at once it's running.
