...
> New to APE? Start with [Getting access](/ape-docs/ape/getting-started/getting-access/.md) – everyone needs `aiw enroll --sso` once, and this page picks up from there.
...
```
sudo npm install -g @bloom-ai-workspace/cli@latest
```
...
## Step 2 – Run `aiw enroll --sso`[​](#step-2--run-aiw-enroll---sso "Direct link to step-2--run-aiw-enroll---sso")
...
| --------------------------------------------------------------------------- | ----------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| `Cannot reach API at http://localhost:3001`                                 | Old CLI version pinned to localhost                         | `sudo npm install -g @bloom-ai-workspace/cli@latest`                                           |
