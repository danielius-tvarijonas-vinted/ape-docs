...
| -------------------------- | --------------------------------------------------- |
| `aiw enroll --sso`         | One-time setup – sign in, create a key, register it |
...
| `sudo aiw update`          | Install the latest CLI                              |
...
Full CLI and SSH documentation: [CLI and SSH onboarding](/ape-docs/ape/reference/cli-and-ssh-onboarding/.md).
...
See [Templates and projects](/ape-docs/ape/concepts/templates-and-projects/.md).
