...
There are three ways to look at your session as code rather than as a running app.
...
For any of that, use SSH – see [CLI and SSH onboarding](/ape-docs/ape/reference/cli-and-ssh-onboarding/.md).
...
The background on how this works is in [How your work is saved](/ape-docs/ape/concepts/how-your-work-is-saved/.md).

## Where to go next[​](#where-to-go-next "Direct link to Where to go next")

* **[How your work is saved](/ape-docs/ape/concepts/how-your-work-is-saved/.md)** – why every prompt is a restore point, and what the agent won't touch.
* **[Pull requests](/ape-docs/ape/shipping/pull-requests/.md)** – the Files tab is the diff a reviewer sees, so this is what comes after it.
* **[Prompting the agent](/ape-docs/ape/the-workspace/prompting-the-agent/.md)** – reverting and re-prompting usually beats asking the agent to undo.
