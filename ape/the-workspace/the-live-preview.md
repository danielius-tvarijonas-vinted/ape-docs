...
See [Sharing](/ape-docs/ape/working-with-others/sharing/.md).
...
* **[Pointing at things](/ape-docs/ape/the-workspace/pointing-at-things/.md)** – click an element in the preview to tell the agent exactly which one you mean.
* **[Sharing](/ape-docs/ape/working-with-others/sharing/.md)** – send someone a link that opens on the route you're looking at.
* **[Sessions](/ape-docs/ape/concepts/sessions/.md)** – what each splash screen and status means.
